...
All computations will be performed with the provided Precision (default 500). As an
additional restriction, s can be restricted to have valuation >= MinVal using the
corresponding parameter, and if Filter is set the value of c in Z/mZ then only values of
